const DepartmentClubs = ({ departmentClubs, slug, department }) => {
  // If this is an office and there are no clubs, render nothing
  if (!departmentClubs || departmentClubs.length === 0) {
    return null;
  }
        ...
        <div className="container">
          <div className="row">
            <div className="rts__section--wrapper">
              <h2 className="rts-section-title">Clubs & Societies</h2>
              <div className="rts__section--link">
                <a
                  href={`/departments/${slug}/clubs`}
          ...
          <div className="row justify-content-md-start justify-content-sm-center g-5">
            {!departmentClubs || departmentClubs.length === 0 ? (
              <div className="col-12">
                ...
                >
                  <h4>No department clubs found</h4>
                  <h6>There are currently no clubs for this department.</h6>
                </div>
              </div>
            ) : (
              departmentClubs.slice(0, 4).map((item) => (
                <div
