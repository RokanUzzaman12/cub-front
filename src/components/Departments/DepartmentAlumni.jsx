const DepartmentAlumni = ({ departmentAlumni, slug, department }) => {
  // If this is an office and there are no clubs, render nothing
  if (!departmentAlumni || departmentAlumni.length === 0) {
    return null;
  }
        ...
        <div className="container">
          <div className="row">
            <div className="rts__section--wrapper">
              <h2 className="rts-section-title">Alumni</h2>
              <div className="rts__section--link">
                <a
                  href={`/departments/${slug}/alumni`}
          ...
          <div className="row justify-content-md-start justify-content-sm-center g-5">
            {!departmentAlumni || departmentAlumni.length === 0 ? (
              <div className="col-12">
                ...
                >
                  <h4>No department department Alumni found</h4>
                  <h6>
                    There are currently no department Alumni for this
                    department.
                  </h6>
                </div>
              </div>
            ) : (
              departmentAlumni.slice(0, 4).map((item) => (
                <div
