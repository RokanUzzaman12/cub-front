...
const DepartmentActivities = ({ departmentActivities, slug, department }) => {
  // If this is an office and there are no activities, render nothing
  if (!departmentActivities || departmentActivities.length === 0) {
    return null;
  }
        ...
        <div className="container">
          <div className="row">
            <div className="rts__section--wrapper">
              <h2 className="rts-section-title">Activities & Updates</h2>
              <div className="rts__section--link">
                <a
                  href={`/departments/${slug}/activities`}
          ...
          <div className="row justify-content-md-start justify-content-sm-center g-5">
            {!departmentActivities || departmentActivities.length === 0 ? (
              <div className="col-12">
                ...
                >
                  ...
                  <h6>There are currently no activities.</h6>
                </div>
              </div>
            ) : (
              departmentActivities.slice(0, 4).map((item) => (
                <div
