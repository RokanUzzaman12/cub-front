...
import { creativeList } from "../../stores/creativeStore";
import { useEffect } from "react";
import { fetchCreativesAndFillStore } from "../../loaders/creativesLoader";

export default function CreativeList() {
  const creatives = useStore(creativeList);

  useEffect(() => {
    fetchCreativesAndFillStore();
  }, []);
                  ...
                  <div className="blog single-blog__content">
                    ...
                    <div className="blog__meta">
                      ...
                      <h5 className="blog__title">
                        <a href={`/creatives/${item.id}`}>{item.title}</a>
                      </h5>
                      <a
