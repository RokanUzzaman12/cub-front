...
const OfficeEmployees = ({ category, department }) => {
    ...
    <>
      {departmentStaffs.map((staff, index) => {
        ...
        const hasSocial =
          ...
          staff?.youtube_link;
        return (
          <div className="col-lg-6 col-md-11" key={key}>
            <div className="single-staff">
              <div className="single-staff__content">
                <div className="staf-image">
                  {staff?.image ? (
                    <img src={staff.image} alt={staff?.name || "staff-image"} />
                  ) : null}
                </div>
                <div className="staf-info">
                  {staff?.name ? <h5 className="name">{staff.name}</h5> : null}
                  {staff?.designation ? (
                  ...
                  {staff?.phone ? (
                    <a href={`tel:${staff.phone}`} className="phone-contact">
                      <span>
                  ...
                  {/* {staff?.id ? (
                    <a
                      href={`/staffs/${category}/${staff.id}`}
                      className="rts-theme-btn border-btn"
                    >
                      More Details
                    </a>
                  ) : null} */}
