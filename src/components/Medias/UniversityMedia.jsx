...
import { mediaList } from "../../stores/mediasStore";
import { useEffect } from "react";
import { fetchMediaAndFillStore } from "../../loaders/mediasLoader";

export default function MediasList() {
  const medias = useStore(mediaList);

  useEffect(() => {
    fetchMediaAndFillStore();
  }, []);
                  ...
                  <div className="blog single-blog__content">
                    ...
                    <div className="blog__meta">
                      ...
                      <h5 className="blog__title">
                        <a target="_blank" href={item.portal_url}>{item.title}</a>
                      </h5>
                      <a
                        href={`/medias/${item.id}`}
