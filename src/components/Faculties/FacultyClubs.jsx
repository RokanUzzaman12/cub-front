...
const FacultyClubs = ({ facultyClubs, slug }) => {
  return (
    <>
       {!facultyClubs || facultyClubs.length === 0 ? null : (
      <div className="rts-blog v_3 rts-section-padding">
        <div className="container">
          <div className="row">
            <div className="rts__section--wrapper">
              <h2 className="rts-section-title">Clubs and Societies</h2>
              <div className="rts__section--link">
                <a
                  href={`/faculties/${slug}/clubs`}
          ...
          <div className="row justify-content-md-start justify-content-sm-center g-5">
            {!facultyClubs || facultyClubs.length === 0 ? (
              <div className="col-12">
                ...
                >
                  <h4>No faculty clubs found</h4>
                  <h6>There are currently no clubs for this faculty.</h6>
                </div>
              </div>
            ) : (
              facultyClubs.slice(0, 4).map((item) => (
                <div
