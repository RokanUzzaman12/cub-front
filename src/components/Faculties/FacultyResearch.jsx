const FacultyResearch = ({ facultyResearch, slug }) => {
  return (
    <>
     {!facultyResearch || facultyResearch.length === 0 ? null : (
          ...
          <div className="row justify-content-md-start justify-content-sm-center g-5">
            {!facultyResearch || facultyResearch.length === 0 ? (
              <div className="col-12">
                ...
                >
                  <h4>No faculty research & publication found</h4>
                  <h6>
                    There are currently no research & publication items for this
                    faculty.
                  </h6>
                </div>
              </div>
            ) : (
              facultyResearch.slice(0, 4).map((item) => (
                <div
