...
import { singleAlumni } from "../../stores/alumni";
import { fetchSingleAlumniAndFillStore } from "../../loaders/alumniLoader";
import { useStore } from "@nanostores/react";

const AlumniDetails = ({ id }) => {
  const alumniDetails = useStore(singleAlumni) || {};
  useEffect(() => {
    fetchSingleAlumniAndFillStore(id);
  }, [id]);
  return (
        ...
        <div className="row sticky-coloum-wrap justify-content-center g-5">
          <div className="col-lg-12 col-md-12">
            <article className="blog-details blog-details--centered">
              ...
              <h3 className="blog-title">{alumniDetails.title}</h3>

              <div className="blog-details__featured-image">
                <img
                  style={{ width: "100%" }}
                  src={alumniDetails.image}
                  alt="blog post"
                />
              </div>
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: alumniDetails.details,
                }}
              />
              {/* Gallery: up to 6 images in 2 rows x 3 columns */}
              {alumniDetails.gallery_images &&
                alumniDetails.gallery_images.length > 0 && (
                  <div
