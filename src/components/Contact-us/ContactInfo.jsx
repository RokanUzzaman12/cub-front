...
import { contactList } from "../../stores/contactsStore";
import { useEffect } from "react";
import { fetchContactsAndFillStore } from "../../loaders/contactsLoader";
import { departmentList } from "../../stores/departmentsStore";
import { fetchDepartmentsAndFillStore } from "../../loaders/departmentsLoader";

const ContactInfo = () => {
  const campas_contacts = useStore(contactList) || [];
  useEffect(() => {
    fetchContactsAndFillStore();
  }, []);
  ...
  console.log("Office departments:", departmentDataList);
  useEffect(() => {
    fetchDepartmentsAndFillStore();
  }, [departmentList]);
  return (
    <>
      {campas_contacts.map((contact, index) => (
        <section className="rts-contact-info pt--120" key={index}>
          <div className="container">
            <div className="row">
              <div className="rts-section rt-center mb--40">
                <h2 className="rts__section--title text-capitalize">
                  {contact.campus_name}
                </h2>
              </div>
            </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-10">
                  <div className="single-contact">
                    <div className="single-contact__single">
                      ...
                      <p className="--p-m">{contact.address}</p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-10">
                  <div className="single-contact">
                    <div className="single-contact__single">
                      ...
                      <div className="method">
                        <a href="callto:+442041542541" className="phone">
                          {contact.admission_hotline}
                        </a>
                        <a href="callto:+442041542542" className="mail">
                          {contact.email}
                        </a>
                      </div>
                    </div>
