...
import { fetchProgramsAndFillStore } from '../../loaders/programsLoader';

const ProgramTutionFees = () => {
      ...
      <section className='program-tution'>
        ...
        <div className='container'>
          <div className='heading-container'>
            <h3 className='heading-title'>Tution & Other Fees</h3>
          </div>
...
export default ProgramTutionFees;
